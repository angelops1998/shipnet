        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Evaluaciones_Grupos_GrupoId",
                        column: x => x.GrupoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SesionesAsistencia", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SesionesAsistencia_Grupos_GrupoId",
                        column: x => x.GrupoId,
                        principalTable: "Grupos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Puntaje = table.Column<decimal>(type: "decimal(65,30)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IntentosEvaluacion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IntentosEvaluacion_Equipos_EquipoId",
                        column: x => x.EquipoId,
                        principalTable: "Equipos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IntentosEvaluacion_Estudiantes_EstudianteId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    SesionAsistenciaId = table.Column<int>(type: "int", nullable: false),
                    EstudianteId = table.Column<int>(type: "int", nullable: false),
                    EquipoId = table.Column<int>(type: "int", nullable: false),
                    HoraRegistro = table.Column<TimeSpan>(type: "time(6)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RegistrosAsistencia_Equipos_EquipoId",
                        column: x => x.EquipoId,
                        principalTable: "Equipos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegistrosAsistencia_Estudiantes_EstudianteId",
                        column: x => x.EstudianteId,
                        principalTable: "Estudiantes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegistrosAsistencia_SesionesAsistencia_SesionAsistenciaId",
                        column: x => x.SesionAsistenciaId,
                        principalTable: "SesionesAsistencia",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IntentosEvaluacion_EquipoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistrosAsistencia_EquipoId",
                table: "RegistrosAsistencia",
                column: "EquipoId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistrosAsistencia_EstudianteId",
                table: "RegistrosAsistencia",
                column: "EstudianteId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistrosAsistencia_SesionAsistenciaId",
                table: "RegistrosAsistencia",
                column: "SesionAsistenciaId");

            migrationBuilder.CreateIndex(
                name: "IX_SesionesAsistencia_GrupoId",
                table: "SesionesAsistencia",
                column: "GrupoId");
        }
